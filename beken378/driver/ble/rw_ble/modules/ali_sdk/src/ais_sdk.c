                                               ...
                                               kernel_task_id_t const src_id)
{
    ...
    if(ais_bt_init_info.ic.on_ccc_change != NULL)
    {
        ais_bt_init_info.ic.on_ccc_change(param->ind_cfg);
    }   
                                               ...
                                               kernel_task_id_t const src_id)
{
    ...
    if(ais_bt_init_info.nc.on_ccc_change != NULL)
    {
        ais_bt_init_info.nc.on_ccc_change(param->ntf_cfg);
    }   
...
static int feb3s_fed5_write_req_ind_handler(kernel_msg_id_t const msgid,
                                     ...
                                     kernel_task_id_t const src_id)
{    
    if(ais_bt_init_info.wc.on_write != NULL)
    {
        ais_bt_init_info.wc.on_write(param->value,param->length);
    }
...
static int feb3s_fed7_write_cmd_ind_handler(kernel_msg_id_t const msgid,
                                     ...
                                     kernel_task_id_t const src_id)
{    
    if(ais_bt_init_info.wwnrc.on_write != NULL)
    {
        ais_bt_init_info.wwnrc.on_write(param->value,param->length);
    }
